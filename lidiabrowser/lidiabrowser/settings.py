"""
Django settings for lidiabrowser project.
...
INSTALLED_APPS = [
    "lidiabrowser.apps.LidiaBrowserAdminConfig",
    "django.contrib.auth",
...
ROOT_URLCONF = "lidiabrowser.urls"
...
STATIC_ROOT = "../htdocs" # Included for local testing
